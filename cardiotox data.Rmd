...
resultados_y_distancias_cardiotox <- evaluar_modelos_distintas_bases(
...
resultados_cardiotox <- resultados_y_distancias_cardiotox$resultados
distancias_cardiotox <- resultados_y_distancias_cardiotox$distancias
...
distancias_cardiotox <- distancias_cardiotox %>%
  mutate(
    modelo1 = case_when(
...
save(resultados_cardiotox, distancias_cardiotox, file = "resultados_cardiotox.RData")

```

```{r}
load("resultados_cardiotox.RData")
```
...
# ---- PLOT 6 ----
####### plot distancias #################
dist_unicas <- distancias_cardiotox %>%
