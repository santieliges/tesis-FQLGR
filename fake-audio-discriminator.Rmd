...
```{r}
 ...
 carpeta_training <- 'for-2sec/for-2sec/training'
 carpeta_training_fake <- 'for-2sec/for-2seconds/training/fake'
 carpeta_training_real <- 'for-2sec/for-2seconds/training/real'
